function readData(filename)
	local file = io.open("C:\\Users\\m_qui\\Documents\\School\\CMPUT 366\\NesEmu\\MyScripts\\smbData"..filename..".dat", "r")
...
function writeData(filename,data)
	local file = io.open("C:\\Users\\m_qui\\Documents\\School\\CMPUT 366\\NesEmu\\MyScripts\\smbData"..filename..".dat", "w")
