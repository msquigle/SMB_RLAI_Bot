...
while(true) do
	...
	if(memory.readbyte(0x000E) == 6 or memory.readbyte(0x000E) == 11) then
		...
		actionValues[area][x][y][lastAction] = actionValues[area][x][y][lastAction] + alpha*(-10 + gamma*actionValues[newarea][newx][newy][action] - actionValues[area][x][y][lastAction])
